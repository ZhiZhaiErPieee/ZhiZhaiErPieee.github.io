setInterval(() => {
  ...
  if ((Number(time[2])<22) && (Number(time[2])>7)){
    ...
    currentTimeHtml ="<img class='boardsign' src='https://img.shields.io/badge/MoonShine的博客-打烊了-6adea8?style=social&logo=coffeescript' title='这个点了应该去睡觉啦，熬夜对身体不好哦'><div id='runtime'>" + time[0] + ' YEAR ' + time[1] + ' DAYS ' + time[2] + ' : ' + time[3] + ' : ' + time[4] + '</div>';   }
